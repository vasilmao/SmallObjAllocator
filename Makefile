...
obj/Chunk.o: src/Chunk.cpp include/FixedAllocator.hpp include/Vector.hpp Makefile
	g++ -I . -I ./include -I ./obj -I ./src -I ./src/examples -Wall -Werror -std=c++17 -c ./src/Chunk.cpp -o obj/Chunk.o

obj/FixedAllocator.o: src/FixedAllocator.cpp include/FixedAllocator.hpp \
 include/Vector.hpp Makefile
	g++ -I . -I ./include -I ./obj -I ./src -I ./src/examples -Wall -Werror -std=c++17 -c ./src/FixedAllocator.cpp -o obj/FixedAllocator.o

obj/example1.o: src/examples/example1.cpp include/FixedAllocator.hpp \
 include/Vector.hpp Makefile
	g++ -I . -I ./include -I ./obj -I ./src -I ./src/examples -Wall -Werror -std=c++17 -c src/examples/example1.cpp -o obj/example1.o

obj/example2.o: src/examples/example2.cpp include/FixedAllocator.hpp \
 include/Vector.hpp Makefile
	g++ -I . -I ./include -I ./obj -I ./src -I ./src/examples -Wall -Werror -std=c++17 -c src/examples/example2.cpp -o obj/example2.o

obj/example3.o: src/examples/example3.cpp include/Allocator.hpp \
 include/FixedAllocator.hpp include/Vector.hpp Makefile
	g++ -I . -I ./include -I ./obj -I ./src -I ./src/examples -Wall -Werror -std=c++17 -c src/examples/example3.cpp -o obj/example3.o
